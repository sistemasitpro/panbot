  ...
  return (
    <>
      <div className="flex flex-col min-h-screen">
        <nav className="bg-white border-gray-200 dark:bg-gray-800 shadow-md dark:shadow-lg">
          <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div
              ...
              id="navbar-user"
            >
              <ul className="flex flex-col font-medium p-4 md:p-0 mt-4  rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-800 w-full">
                <li>
                  <Link
                    to="/add-expense"
                    onClick={closeMenu}
